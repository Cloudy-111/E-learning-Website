...
// /* ========== Full-bleed helpers (KHÔNG max-width) ========== */
// const Section = ({ id, title, subtitle, action, children, className = "" }) => (
//   <section
//     id={id}
//     className={`w-screen overflow-x-hidden py-12 lg:py-16 ${className}`}
//   >
//     {/* không max-width, không mx-auto */}
//     <div className="w-screen px-0">
//       {(title || subtitle || action) && (
//         <div className="mb-8 flex items-end justify-between gap-4 px-6 lg:px-12">
//           <div>
...
//         </div>
//       )}
//       {/* phần nội dung section tự full-width; nếu muốn chừa mép, thêm px-6 tại chỗ */}
//       {children}
//     </div>
//   </section>
// );
...
//   <button
//     className={
//       "rounded-full border border-[#54c3be] text-[#54c3be] px-5 py-3 hover:bg-[#54c3be]/10 transition " +
//       className
//     }
//     {...props}
//   >
...
//         (highlighted ? "shadow-xl ring-2 ring-[#54c3be]" : "hover:shadow-sm transition")
//       }
//     >
//       {badge && (
//         <span className="absolute -top-3 right-4 text-xs rounded-full bg-[#54c3be] text-white px-3 py-1 shadow">
//           {badge}
//         </span>
//       )}
...
//             <svg width="18" height="18" viewBox="0 0 24 24" className="mt-0.5" fill="none" stroke="#54c3be" strokeWidth="2">
...
//     "Themed vào 3 style khác nhau",
//   ];
//   return (
//     <Section
//       id="pricing"
//       title="Bảng giá hợp lý"
//       subtitle="Chọn gói phù hợp và bắt đầu ngay"
//     >
//       {/* lưới full-width nhưng vẫn chừa mép nhẹ bằng px-6 để không dính sát mép */}
//       <div className="px-6 lg:px-12">
//         <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
//           <PriceCard
//             title="Miễn phí"
//             subtitle="Gói miễn phí"
//             features={["Hệ thống xây dựng theo thành phần", "Tối ưu", "Bộ icon đẹp"]}
//             cta="Try for free"
//           />
//           <PriceCard
//             title="$24 / month"
//             subtitle="Cá nhân 24$/tháng"
//             price="$24"
//             unit="/ month"
//             features={[...features, "Sẽ giúp bạn học Figma", "Regular license"]}
//             cta="Bắt đầu dùng"
//           />
//           <PriceCard
//             title="$12 / editor"
//             subtitle="Doanh nghiệp — 12$/người dùng"
//             price="$12"
//             unit="/ editor"
//             features={[...features, "Extended license"]}
//             cta="Mua gói doanh nghiệp"
//             highlighted
//             badge="best!"
//           />
//         </div>
...
// function FAQ() {
//   const data = [
//     { q: "Online coaching lessons for remote learning", a: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor." },
//     { q: "Lorem ipsum dolor sit amet", a: "Nội dung mẫu cho phần trả lời." },
//     { q: "Consectetur adipiscing elit, sed do", a: "Phần giải đáp mẫu cho câu hỏi." },
//     { q: "Eiusmod tempos Lorem ipsum", a: "Mô tả thêm…" },
//   ];
...
//           <h3 className="text-lg font-semibold">Online coaching lessons for remote learning.</h3>
//           <p className="text-slate-600 mt-2">
//             Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor… (mẫu nội dung).
//           </p>
//           <Primary className="mt-4">Start learning now</Primary>
//         </div>
...
//   const list = useMemo(
//     () => Array.from({ length: 4 }).map((_, i) => ({ id: i, name: "Bulkin Simons", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod…" })),
//     []
//   );
...
//       action={
//         <div className="px-6 lg:px-12 flex items-center gap-2">
...
//       }
//     >
//       <div ref={ref} className="px-6 lg:px-12 flex gap-6 overflow-x-auto no-scrollbar">
//         {list.map((t) => (
...
// function Apps() {
//   return (
//     <Section id="apps" title="APP is available for free" subtitle="Android & iOS">
//       <div className="px-6 lg:px-12 flex flex-wrap items-center gap-4">
//         <a href="#" className="inline-flex items-center gap-3 rounded-xl border px-4 py-3 bg-white hover:shadow-sm">
//           <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M17.6 9H6.4A1.4 1.4 0 0 0 5 10.4v6.2A1.4 1.4 0 0 0 6.4 18h11.2a1.4 1.4 0 0 0 1.4-1.4v-6.2A1.4 1.4 0 0 0 17.6 9Z"/><path d="M8 9V7M16 9V7M9 6l-1-2M15 6l1-2"/></svg>
//           <div className="leading-tight">
//             <div className="text-xs text-slate-500">Android APP</div>
//             <div className="font-medium">Tải miễn phí</div>
//           </div>
//         </a>
//         <a href="#" className="inline-flex items-center gap-3 rounded-xl border px-4 py-3 bg-white hover:shadow-sm">
//           <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M16 13c0 4-3 8-6 8s-5-3-5-7 3-8 6-8 5 3 5 7Z"/><path d="M20 8c-1 1-2 1-3 1 0-1 1-3 3-3"/></svg>
//           <div className="leading-tight">
...
//   return (
//     <Section>
//       <div className="px-6 lg:px-12 grid grid-cols-1 md:grid-cols-2 gap-6">
//         <Card
...
//     <>
//       <Header />
//       {/* HERO full-bleed, hoàn toàn không padding */}
//       <section className="w-screen overflow-x-hidden pt-10">
//         <div className="px-6 lg:px-12 flex items-end justify-between">
//           <div>
//             <h1 className="text-3xl lg:text-4xl font-extrabold">Bảng giá hợp lý</h1>
//             <p className="text-slate-600 mt-2">Chọn gói và phát triển cùng PTIT E-Learning</p>
//           </div>
//           <Link to="/register" className="text-[#54c3be] hover:underline">Đăng ký ngay</Link>
//         </div>
//         <div className="mt-6 w-screen h-48 rounded-2xl bg-gradient-to-tr from-orange-100 via-rose-100 to-amber-100 grid place-items-center">
//           <span className="text-sm text-slate-500">Ảnh hero (thay sau)</span>
//         </div>
//       </section>
