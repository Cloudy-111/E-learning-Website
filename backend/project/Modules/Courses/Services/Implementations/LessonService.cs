...
public class LessonService : ILessonService
{
    ...
    public async Task<LessonInformationDTO> GetLessonByIdAsync(string id)
    {
    ...
    public async Task AddLessonAsync(LessonCreateDTO lessonDto)
    {
        var courseContentExist = await _courseContentRepository.CourseContentExistsByContentIdAsync(lessonDto.CourseContentId);
        if (!courseContentExist)
        {
            throw new Exception($"Course content with id: {lessonDto.CourseContentId} not found");
        }
        ...
        var lesson = new Lesson
        {
            ...
            CourseContentId = lessonDto.CourseContentId
        };
